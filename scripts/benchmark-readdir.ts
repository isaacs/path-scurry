...
//
// At 500k to 1M entries, PathWalker isn't significantly faster than
...
// especially since PathWalker uses fs.readdir() rather than opendir.
...
const cases: () => (
  ...
  // 'PathWalker async with promise stack, no check',
